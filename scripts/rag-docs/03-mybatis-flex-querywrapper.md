## 灵活的 QueryWrapper - MyBatis-Flex 官方网站

**Source**: https://mybatis-flex.com/zh/base/querywrapper.html

---

[Skip to content](https://mybatis-flex.com/zh/base/querywrapper.html#VPContent)

章节

[成为赞助者](https://mybatis-flex.com/zh/becoming-a-sponsor.html)

[信创 CMS](http://www.jpress.cn)

[http://www.codeformat.cn](http://www.codeformat.cn)

虚位以待

虚位以待

[https://www.orangeforms.com](https://www.orangeforms.com)

[https://gitee.com/aiflowy/aiflowy](https://gitee.com/aiflowy/aiflowy)

# 灵活的 QueryWrapper [​](https://mybatis-flex.com/zh/base/querywrapper.html#%E7%81%B5%E6%B4%BB%E7%9A%84-querywrapper)
...
## QueryWrapper 的使用 [​](https://mybatis-flex.com/zh/base/querywrapper.html#querywrapper-%E7%9A%84%E4%BD%BF%E7%94%A8)
...
## select * [​](https://mybatis-flex.com/zh/base/querywrapper.html#select)
...
## select ... as [​](https://mybatis-flex.com/zh/base/querywrapper.html#select-as)
...
## select 多张表 [​](https://mybatis-flex.com/zh/base/querywrapper.html#select-%E5%A4%9A%E5%BC%A0%E8%A1%A8)
...
## select function（SQL 函数） [​](https://mybatis-flex.com/zh/base/querywrapper.html#select-function-sql-%E5%87%BD%E6%95%B0)
...
目前，MyBatis-Flex 已支持 110+ 个常见的 SQL 函数，查看已支持的 [所有函数](https://gitee.com/mybatis-flex/mybatis-flex/blob/main/mybatis-flex-core/src/main/java/com/mybatisflex/core/constant/FuncName.java)。 若还不满足，您可以参考 [QueryMethods](https://gitee.com/mybatis-flex/mybatis-flex/blob/main/mybatis-flex-core/src/main/java/com/mybatisflex/core/query/QueryMethods.java) ，然后在自己的项目里进行自定义扩展。
...
## select 列计算 [​](https://mybatis-flex.com/zh/base/querywrapper.html#select-%E5%88%97%E8%AE%A1%E7%AE%97)

#### 示例 1： [​](https://mybatis-flex.com/zh/base/querywrapper.html#%E7%A4%BA%E4%BE%8B-1)
...
#### 示例 2： [​](https://mybatis-flex.com/zh/base/querywrapper.html#%E7%A4%BA%E4%BE%8B-2)
...
#### 示例 3： [​](https://mybatis-flex.com/zh/base/querywrapper.html#%E7%A4%BA%E4%BE%8B-3)
...
## select 取相反数 [​](https://mybatis-flex.com/zh/base/querywrapper.html#select-%E5%8F%96%E7%9B%B8%E5%8F%8D%E6%95%B0)
...
## select case...when [​](https://mybatis-flex.com/zh/base/querywrapper.html#select-case-when)
...
在以上示例中，由于 `case` 和 `else` 属于 Java 关键字，无法使用其进行方法命名，因此会添加一个下划线小尾巴 `"_"` 变成 `case_` 和 `else_`，这是无奈之举。 在以后的 QueryWrapper 构建中，遇到 java 关键字也会采用类似的解决方法。

## with...select [​](https://mybatis-flex.com/zh/base/querywrapper.html#with-select)
...
## with recursive...select [​](https://mybatis-flex.com/zh/base/querywrapper.html#with-recursive-select)
...
## where [​](https://mybatis-flex.com/zh/base/querywrapper.html#where)
...
## where 动态条件 [​](https://mybatis-flex.com/zh/base/querywrapper.html#where-%E5%8A%A8%E6%80%81%E6%9D%A1%E4%BB%B6)
...
## where 使用 SQL 函数 [​](https://mybatis-flex.com/zh/base/querywrapper.html#where-%E4%BD%BF%E7%94%A8-sql-%E5%87%BD%E6%95%B0)
...
## where select [​](https://mybatis-flex.com/zh/base/querywrapper.html#where-select)
...
## where exists, not exists [​](https://mybatis-flex.com/zh/base/querywrapper.html#where-exists-not-exists)
...
## and (...) or (...) [​](https://mybatis-flex.com/zh/base/querywrapper.html#and-or)
...
## group by [​](https://mybatis-flex.com/zh/base/querywrapper.html#group-by)
...
## having [​](https://mybatis-flex.com/zh/base/querywrapper.html#having)
...
## orderBy [​](https://mybatis-flex.com/zh/base/querywrapper.html#orderby)
...
## orderBy 动态排序 [​](https://mybatis-flex.com/zh/base/querywrapper.html#orderby-%E5%8A%A8%E6%80%81%E6%8E%92%E5%BA%8F)
...
## hint [​](https://mybatis-flex.com/zh/base/querywrapper.html#hint)
...
## join（left join，inner join...） [​](https://mybatis-flex.com/zh/base/querywrapper.html#join-left-join-inner-join)
...
## join on 多个条件 [​](https://mybatis-flex.com/zh/base/querywrapper.html#join-on-%E5%A4%9A%E4%B8%AA%E6%9D%A1%E4%BB%B6)
...
## join select [​](https://mybatis-flex.com/zh/base/querywrapper.html#join-select)
...
## join 自己 [​](https://mybatis-flex.com/zh/base/querywrapper.html#join-%E8%87%AA%E5%B7%B1)
...
## union, union all [​](https://mybatis-flex.com/zh/base/querywrapper.html#union-union-all)
...
## limit... offset [​](https://mybatis-flex.com/zh/base/querywrapper.html#limit-offset)
...
## Lambda 扩展 [​](https://mybatis-flex.com/zh/base/querywrapper.html#lambda-%E6%89%A9%E5%B1%95)
...
## MyBatis-Plus 兼容 API 
^ v1.7.2
[​](https://mybatis-flex.com/zh/base/querywrapper.html#mybatis-plus-%E5%85%BC%E5%AE%B9-api)
...
## Entity 转化为 QueryWrapper [​](https://mybatis-flex.com/zh/base/querywrapper.html#entity-%E8%BD%AC%E5%8C%96%E4%B8%BA-querywrapper)
...
## Map 转化为 QueryWrapper [​](https://mybatis-flex.com/zh/base/querywrapper.html#map-%E8%BD%AC%E5%8C%96%E4%B8%BA-querywrapper)

方法同 [Entity 转化为 QueryWrapper](https://mybatis-flex.com/zh/base/querywrapper.html#entity-%E8%BD%AC%E5%8C%96%E4%B8%BA-querywrapper) 类似，只需要把 entity 变量替换为 map 即可。

## QueryWrapper 序列化 [​](https://mybatis-flex.com/zh/base/querywrapper.html#querywrapper-%E5%BA%8F%E5%88%97%E5%8C%96)
...
## QueryWrapper 克隆 [​](https://mybatis-flex.com/zh/base/querywrapper.html#querywrapper-%E5%85%8B%E9%9A%86)
...
## 特别注意事项!!! [​](https://mybatis-flex.com/zh/base/querywrapper.html#%E7%89%B9%E5%88%AB%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9)
...
## QueryColumnBehavior 
^ v1.5.7
[​](https://mybatis-flex.com/zh/base/querywrapper.html#querycolumnbehavior)
...
## 存在疑问？ [​](https://mybatis-flex.com/zh/base/querywrapper.html#%E5%AD%98%E5%9C%A8%E7%96%91%E9%97%AE)
...
![](https://mybatis-flex.com/assets/build_idea.53vQKc2W.png)

> 更多关于 APT 的配置，请进入 [APT 配置章节](https://mybatis-flex.com/zh/others/apt.html) 了解。
