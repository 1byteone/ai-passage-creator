...
import com.example.aipassagecreator.config.PexelsConfig;
...
import static com.example.aipassagecreator.constant.ArticleConstant.*;
...
public class PexelsService implements ImageSearchService {
    ...
    private String extractImageUrl(String responseBody, String keywords) {
        com.google.gson.JsonObject jsonObject = JsonParser.parseString(responseBody).getAsJsonObject();
        ...
        com.google.gson.JsonObject photo = photos.get(0).getAsJsonObject();
